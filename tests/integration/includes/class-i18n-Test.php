...
/**
 * Class BH_WP_Auto_Purchase_Stampscom_Test
 *
 * @see I18n
 */
class BH_WP_Auto_Purchase_Stampscom_I18n_Test extends \Codeception\TestCase\WPTestCase {
	...
	public function test_load_plugin_textdomain() {
		...
		$this->assertTrue( is_textdomain_loaded( 'bh-wp-auto-purchase-stampscom' ), 'i18n text domain not loaded.' );
